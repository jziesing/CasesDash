...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Case = __webpack_require__(225);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'case/:title', component: _Case2.default })
	  )
	...
	var Home = function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function renderData() {
	      return this.state.search_commits.map(function (commit, index) {
	        var author = commit.author ? commit.author.login : 'Anonymous';
	        var route = 'case/' + author + '-' + index;
	        return _react2.default.createElement(
	          'tr',
	          { key: index },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'text', className: 'form-control', value: this.state.searchString, onChange: this.handleChange.bind(this), placeholder: 'Search', 'aria-describedby': 'basic-addon1' }),
	                _react2.default.createElement(
	                  'span',
	                  { className: 'input-group-addon', id: 'basic-addon1' },
	                  '$$'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Case = function (_React$Component) {
	  ...
	  function Case(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Case).call(this, props));
	  ...
	  _createClass(Case, [{
	    ...
	    key: 'fetchCase',
	    value: function fetchCase(case_id) {
	      var _this2 = this;

	      _superagent2.default.get('//MyRestEndpoint/case/' + case_id).end(function (error, response) {
	        if (!error && response) {
	          _this2.setState(_defineProperty({}, state, response.body));
	        } else {
	          console.log('Error fetching ' + type, error);
